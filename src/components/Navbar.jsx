      ...
      >
        ...
        <div className="offcanvas-body ms-lg-auto d-flex flex-column h-100 offcavas-bg">
          <ul className="navbar-nav">
            ...
            <li className="nav-item" data-bs-dismiss="offcanvas">
              <NextLink href="#" title="Sobre el proyecto" className="nav-link" />
            </li>
            ...
            <li className="nav-item" data-bs-dismiss="offcanvas">
              <NextLink href="#" title="Contacto" className="nav-link" />
            </li>
            <li
          ...
          <div className="offcanvas-footer d-lg-none">
            <div>
              <NextLink
                title="scanvitali@gmail.com"
                className="link-inverse"
                href="mailto:scanvitali@gmail.com"
              />
              <br />
              <NextLink href="tel:+523334567890" title="+5233128 50036" />
              <br />
              <SocialLinks />
            </div>
          </div>
